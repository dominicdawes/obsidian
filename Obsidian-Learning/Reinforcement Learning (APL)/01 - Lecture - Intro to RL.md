...
* represents the expected ($E$) cumulative reward an agent can obtain by taking a specific action 'a' in a particular state 's' and then following a specific policy
